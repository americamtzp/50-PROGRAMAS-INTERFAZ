...
Descripción: Este programa en ensamblador ARM convierte una cadena ASCII de dígitos en un número entero
             y luego convierte el entero de nuevo a una cadena ASCII. Finalmente, muestra la cadena resultante.
...
class Program
{
    static void Main()
    {
        string input = "12345"; // Cadena de entrada
        int result = 0;
        ...
        // Convertir de int a ASCII
        string output = result.ToString();
        
        Console.WriteLine("El resultado convertido es: " + output);
    }
}
*/
