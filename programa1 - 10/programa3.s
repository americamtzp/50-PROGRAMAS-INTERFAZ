/*
Nombre: Resta de dos números en ensamblador ARM
Fecha: 5 de noviembre de 2024
Descripción: Este programa en ensamblador ARM solicita dos números al usuario, calcula la resta del primero menos el segundo y muestra el resultado en pantalla.
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("La resta es: {0}", result);
    }
}
*/
