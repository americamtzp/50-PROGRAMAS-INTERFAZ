/* 
Nombre: America Martinez Perez
Fecha: 5 de noviembre de 2024
Descripción: Este programa en ensamblador ARM ordena un array de números utilizando el método de selección. Primero, el programa muestra un mensaje de inicio, luego ordena el array y finalmente imprime el array ordenado en consola.
...
class Program
{
    static void Main()
    {
        ...
        // Método de selección para ordenar el array
        for (int i = 0; i < array.Length - 1; i++)
        {
            int minIndex = i;
            
            // Buscar el índice del mínimo en la sublista no ordenada
