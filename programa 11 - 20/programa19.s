...
Descripción: Este programa en C llama a una función en ensamblador ARM64 para realizar la suma de dos matrices de 3x3. La función ensambladora toma las matrices `matrizA` y `matrizB` y almacena el resultado en `resultado`.
